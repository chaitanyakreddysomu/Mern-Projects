    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                login(updatedUser.role, updatedUser); // Update global context
                setIsEditing(false);
                setSelectedFile(null);
                setPreviewImage(null); // Helper to switch to using remote URL
                ...
                <CardContent className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input value={formData.bloodGroup || ""} onChange={(e) => handleInputChange('root', 'bloodGroup', e.target.value)} disabled={!isEditing} className="h-11 border-orange-100 focus-visible:ring-orange-500 disabled:opacity-100 disabled:text-foreground disabled:bg-background" />
                            </div>
                        </div>
                    </div>
                </CardContent>
