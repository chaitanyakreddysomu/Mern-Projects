...
export default function AdminRequests() {
    const [requests, setRequests] = useState<any[]>(SAMPLE_DATA);
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-slate-50 p-4 rounded-lg border">
                <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto items-center">
                    ...
                    <select
                        className="h-10 w-full md:w-[150px] rounded-md border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                        value={roleFilter}
                        ...
                        <div className="space-y-6 pt-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <Badge
                                        variant="secondary"
                                        className={`font-semibold ${selectedRequest.role === 'HR'
